...
export default function LeftPanels({ t, theme, activePanel, close, stats, events, tasks, settings, setSettings, onSimulateDistraction, onAddFocusEvent, onDeleteEvent, onClearEvents, onSelectTask, onCreateTask, onUpdateTaskDate, onDeleteTask, onToggleTask, historyRecords, activeTaskId, showToast }) {
