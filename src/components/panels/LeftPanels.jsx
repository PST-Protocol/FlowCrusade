...
export default function LeftPanels({ t, theme, activePanel, close, stats, events, tasks, settings, setSettings, onSimulateDistraction, onAddFocusEvent, onDeleteEvent, onClearEvents, onSelectTask, onCreateTask, onDeleteTask, onToggleTask, activeTaskId, showToast }) {
